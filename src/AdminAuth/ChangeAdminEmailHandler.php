...
final readonly class ChangeAdminEmailHandler
{
    public function __construct(
        private ChangeAdminEmailUseCaseInterface $useCase,
    ...
    public function handle(ServerRequestInterface $request): ResponseInterface
    {
        ...
        if ($newEmail === '') {
            $errors[] = new ValidationError('new_email', 'New email is required.', 'required');
        }
