...
NeNe Corpus coding standards split by surface. **Full policies live in the dedicated documents below** — this file is the index.
...
- Application Problem Details `type`: `https://nene-corpus.dev/problems/{problem-name}`
...
- **Never integrate chat into NeNe Records** — ADR 0002
