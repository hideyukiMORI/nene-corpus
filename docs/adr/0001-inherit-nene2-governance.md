...
NeNe Corpus is a consumer application built on [NENE2](https://github.com/hideyukiMORI/NENE2). The maintainer wants the same strict engineering discipline as NENE2 and [NeNe Records](https://github.com/hideyukiMORI/nene-records) — Issue-driven workflow, Conventional Commits, self-review checklists, and AI-readable documentation — without copying the entire NENE2 documentation tree.

Alternatives considered:

1. **Link-only** — rejected; product-specific rules (chat, ingestion, NeNe Records boundary) would be unclear.
...
- Product rules (corpus model, chat API, upstream boundaries) stay separate from framework rules.
...
- Add corpus and chat ADRs as domains stabilize.
