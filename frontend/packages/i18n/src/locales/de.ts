...
export const de = defineMessages({
  ...
  'admin.appearance.heroCtaLabel': 'CTA-Schaltfläche',
  'admin.appearance.heroCtaLabelPlaceholder': 'Frage stellen',
  'admin.appearance.heroShowTitle': 'Titel anzeigen',
  'admin.appearance.heroShowDescription': 'Beschreibung anzeigen',
  'admin.appearance.heroShowCta': 'CTA-Schaltfläche anzeigen',
