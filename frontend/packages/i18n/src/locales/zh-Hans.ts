...
export const zhHans = defineMessages({
  ...
  'admin.appearance.heroWelcomeTitle': '标题',
  ...
  'admin.appearance.heroCtaLabel': 'CTA 按钮',
  'admin.appearance.heroCtaLabelPlaceholder': '开始提问',
  'admin.appearance.heroShowTitle': '显示标题',
  'admin.appearance.heroShowDescription': '显示说明',
  'admin.appearance.heroShowCta': '显示 CTA 按钮',
